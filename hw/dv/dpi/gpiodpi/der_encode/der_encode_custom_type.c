                                 ...
                                 unsigned char *out,  unsigned long *outlen)
{
   ...
   if (root->pc == LTC_ASN1_PC_PRIMITIVE) {
      ...
      list = (const ltc_asn1_list*)root->data;
      inlen = root->size;
   ...
   for (i = 0; i < inlen; i++) {
       ...
       switch (type) {
           ...
           case LTC_ASN1_BIT_STRING:
               z = *outlen;
               if ((err = der_encode_bit_string((const unsigned char*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_RAW_BIT_STRING:
               z = *outlen;
               if ((err = der_encode_raw_bit_string((const unsigned char*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_OCTET_STRING:
               z = *outlen;
               if ((err = der_encode_octet_string((const unsigned char*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_OBJECT_IDENTIFIER:
               z = *outlen;
               if ((err = der_encode_object_identifier((const long unsigned int*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_IA5_STRING:
               z = *outlen;
               if ((err = der_encode_ia5_string((const unsigned char*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_PRINTABLE_STRING:
               z = *outlen;
               if ((err = der_encode_printable_string((const unsigned char*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_UTF8_STRING:
               z = *outlen;
               if ((err = der_encode_utf8_string((const wchar_t*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_UTCTIME:
               z = *outlen;
               if ((err = der_encode_utctime((const ltc_utctime*)data, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_GENERALIZEDTIME:
               z = *outlen;
               if ((err = der_encode_generalizedtime((const ltc_generalizedtime*)data, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_SET:
               z = *outlen;
               if ((err = der_encode_set((const ltc_asn1_list*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_SETOF:
               z = *outlen;
               if ((err = der_encode_setof((const ltc_asn1_list*)data, size, out + x, &z)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
           ...
           case LTC_ASN1_SEQUENCE:
               z = *outlen;
               if ((err = der_encode_sequence_ex((const ltc_asn1_list*)data, size, out + x, &z, type)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               break;
