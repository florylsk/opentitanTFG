   ...
   for (i = 0; i < inlen; i++) {
       ...
       switch (type) {
           ...
           case LTC_ASN1_OBJECT_IDENTIFIER:
               if ((err = der_length_object_identifier((const long unsigned int*)data, size, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_IA5_STRING:
               if ((err = der_length_ia5_string((const unsigned char*)data, size, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_TELETEX_STRING:
               if ((err = der_length_teletex_string((const unsigned char*)data, size, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_PRINTABLE_STRING:
               if ((err = der_length_printable_string((const unsigned char*)data, size, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_UTCTIME:
               if ((err = der_length_utctime((const ltc_utctime*)data, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_GENERALIZEDTIME:
               if ((err = der_length_generalizedtime((const ltc_generalizedtime*)data, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_UTF8_STRING:
               if ((err = der_length_utf8_string((const wchar_t*)data, size, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
           ...
           case LTC_ASN1_SEQUENCE:
               if ((err = der_length_sequence((const ltc_asn1_list*)data, size, &x)) != CRYPT_OK) {
                  goto LBL_ERR;
               }
               y += x;
               break;
